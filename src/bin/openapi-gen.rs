...
use openapi_generator::{CodeGenerator, ConfigFile, SchemaAnalyzer};
...
enum Commands {
    ...
    Generate {
        /// Path to configuration file (openapi-generator.toml)
        #[arg(short, long, default_value = "openapi-generator.toml")]
        config: PathBuf,
    },
